...
export function InteractiveScroll() {
  ...
  function getAnimatedElementsNow(e) {
    ...
    const elementRigth = document.querySelectorAll(".animatedElementRigthNow");
    if (elementRigth.length > 0) {
      elementRigth.forEach((e) => {
        if (e.getBoundingClientRect()) {
          e.style.opacity = "1";
    ...
    const elementLeft = document.querySelectorAll(".animatedElementLeftNow");
  ...
  function getAnimatedElements(e) {
    ...
    if (elementLeft.length > 0) {
      elementLeft.forEach((e) => {
        if (e.getBoundingClientRect().y <= window.innerHeight / 1.4) {
          e.style.opacity = "1";
          e.style.transform = "translateX(0px)";
        }
      });
