            ...
            <div id="plans" className=" sm:w-[30rem] w-[20rem] pb-10 m-auto shadow-shadow7xl rounded-2xl">
                ...
                <div className="mt-10 flex justify-center flex-col items-center">
                    ...
                    <div className='lg:w-80 w-72  m-auto mt-10'>
                        <a href='SEU-LINK-AQUI'><button className={`${montserrat.className} sm:text-lg tracking-wide hover:brightness-125 duration-200 lg:w-80 w-72 rounded-xl h-14 shadow-shadowButton bg-[#00D208] text-white `}>EU QUERO</button></a>
                    </div>
                </div>
            </div>
        </div>
